...
func (as *Server) registerRoutes() {
	...
	router.HandleFunc("/campaigns/trash", as.CampaignsTrash)
	...
	router.HandleFunc("/campaigns/{id:[0-9]+}/restore", as.CampaignRestore)
	router.HandleFunc("/campaigns/{id:[0-9]+}/purge", as.CampaignPurge)
