...
// NewPhishingTemplateContextFromCampaign creates a PhishingTemplateContext from a Campaign (for calendar campaigns)
func NewPhishingTemplateContextFromCampaign(c *Campaign, r BaseRecipient, rid string) (PhishingTemplateContext, error) {
	ptx, err := NewPhishingTemplateContext(c, r, rid)
	if err != nil {
		return PhishingTemplateContext{}, err
	}
...
func ValidateTemplate(text string) error {
	...
	// Add calendar fields for validation (they will be empty for non-calendar campaigns)
	ptx.EventTitle = "Sample Event"
	ptx.EventDescription = "Sample Description"
	ptx.EventStartTime = "2025-01-01 10:00 AM"
	ptx.EventDuration = 60
	ptx.OrganizerName = "Sample Organizer"
	ptx.OrganizerEmail = "organizer@example.com"
